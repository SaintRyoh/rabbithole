...
function Dropdown:display()
    ...
    -- Extract repetitive animation logic into a separate function
        local function animateHeight(target_height)
            ...
            gears.timer.start_new(step_delay, function()
                local new_height = outCubic(current_step, 1, target_height - 1, anim_steps)
        ...
        if not self.visible then
            ...
            -- Showing animation
            animateHeight(target_geometry.height)
        end
