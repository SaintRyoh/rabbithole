...
local theme_table = Tesseract:generate_theme("https://raw.githubusercontent.com/user/repo/branch/theme_file.lua")

-- Use a local file to fetch the theme. This will return the theme table
local theme_table = Tesseract:generate_theme("/path/to/your/theme/file.lua")

-- Use chromaticTesseract to generate theme. This will return the theme table
local theme_table = Tesseract:generate_theme(nil, "#4CAF50", "complementary", {
